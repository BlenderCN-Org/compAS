...
class DisplayLabels(Mixin):
    ...
    def display_vertex_labels(self, display=True, layer=None):
    ...
    def display_edge_labels(self, display=True, layer=None):
    ...
    def display_face_labels(self, display=True, layer=None):
