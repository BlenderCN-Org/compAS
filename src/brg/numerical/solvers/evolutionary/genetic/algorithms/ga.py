...
class GA:
    ...
    #TODO: Make GA.from_json or GA.from_data function to simplify use. Default values
    #      could also be used. 
    ...
    def ga(self):
        ...
        for generation in range(start_gen_number,self.num_gen):
            ...
            if generation < self.num_gen-1 and self.min_fit_flag == False:
    ...
    def write_out_file(self,generation):
        ...
        """
        filename  = 'generation_'+ "%04d" % generation + '_population'+ ".pop"
    ...
    def get_pop_from_pop_file(self,gen):
        ...
        file_pop  = {'binary':{},'decoded':{},'scaled':{},'fit_value':{},
                     'pf':{}}
        filename  = 'generation_'+ "%04d" % gen + '_population'+ ".pop"
