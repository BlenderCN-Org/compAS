"""This module defines a ``Polyline`` object, and ways to interact with and
operate on it.
"""

from brg.geometry.elements.point import Point
from brg.geometry.elements.line import Line
from brg.geometry.planar import is_selfintersecting
...
class Polyline(object):
    ...
    def is_selfintersecting(self):
        ...
        """
        return is_selfintersecting(self.points)
