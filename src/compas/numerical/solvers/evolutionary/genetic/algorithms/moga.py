...
class MOGA:
    ...
    def calculate_crowding_distance(self):
        ...
        for i in range(self.num_fit_func):
            ...
            if self.fit_type[i] == 1:
                self.sorted_indices = self.get_sorting_indices(self.pf_values,reverse=False) # reverse used to be True
            else:
    ...
    def nsga_tournament(self):
        ...
        for i in range(self.num_pop):
            ...
            #temp_pf_individuals_b = np.delete(tempPFindividualsB,0,0)
