                ...
                for j in range(len(func_combinations)):
                    ...
                    for i in range(self.num_pop):
                        ...
                        if self.pop['pf'][i] == 0:
                            ...
                            if number:
                                ax.text(x+(a*0.2),y+(a_*0.2), str(i),verticalalignment='top',horizontalalignment='right',color=color, fontsize=size)
                        else:
                    ...
                    if self.fixed_individuals:
                        for i in range(len(self.fixed_individuals)):
                            x,y = self.fixed_individuals['fit_values'][i][f1],self.fixed_individuals['fit_values'][i][f2]
                            if self.conversion_functions:
                                x = self.conversion_functions[f1](x)
                                y = self.conversion_functions[f2](y)
                            color = '0.1'
