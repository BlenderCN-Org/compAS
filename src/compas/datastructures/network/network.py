...
""".format(self.attributes['name'], v, e, dmin, dmax, dva, dea)
    ...
    def data(self, rdata):
        ...
        max_int_key  = rdata.get('max_int_key', -1)
        max_int_fkey = rdata.get('max_int_fkey', -1)

        # support older versions of data as well (vcount, fcount)
