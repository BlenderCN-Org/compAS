...
sys.path.insert(0, "/Users/vanmelet/bitbucket/compas_framework/libs/ShapeOp.0.1.0/build/libShapeOp/bindings/python")
...
if __name__ == '__main__':
    ...
    from compas.datastructures.mesh.viewer import MultiMeshViewer
    from compas.datastructures.mesh.numerical.methods import mesh_fd

    mesh = Mesh.from_obj(compas.find_resource('faces.obj'))
